...
Begin VB.Form frm_ExcepcionesHrs 
   ...
   ClientTop       =   330
   ClientWidth     =   6030
   Icon            =   "frm_ExcepcionesHrs.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cmd_Tipito 
            Appearance      =   0  'Flat
            DisabledPicture =   "frm_ExcepcionesHrs.frx":0ECA
            Height          =   315
            Left            =   120
            MaskColor       =   &H00FFFFFF&
            Picture         =   "frm_ExcepcionesHrs.frx":15DA
            Style           =   1  'Graphical
            TabIndex        =   45
            ToolTipText     =   "Agregar"
            Top             =   120
         ...
         Begin VB.PictureBox Pic_Tipito 
            ...
            Height          =   315
            Left            =   120
            MouseIcon       =   "frm_ExcepcionesHrs.frx":186A
            Picture         =   "frm_ExcepcionesHrs.frx":19BC
            ScaleHeight     =   315
            ScaleWidth      =   315
            TabIndex        =   44
            Top             =   120
         ...
         Begin VB.PictureBox Pic_Tipito_Gris 
            ...
            Height          =   315
            Left            =   120
            MouseIcon       =   "frm_ExcepcionesHrs.frx":1C4C
            Picture         =   "frm_ExcepcionesHrs.frx":1D9E
            ScaleHeight     =   315
            ScaleWidth      =   315
            TabIndex        =   46
            Top             =   120
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "frm_ExcepcionesHrs.frx":1ECE
   ...
   Begin VB.Frame fme_botones_abm 
      ...
      Begin VB.CommandButton cmdAceptar 
         Appearance      =   0  'Flat
         DisabledPicture =   "frm_ExcepcionesHrs.frx":1EE3
         Height          =   375
         Left            =   4680
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "frm_ExcepcionesHrs.frx":203C
         Picture         =   "frm_ExcepcionesHrs.frx":218E
         Style           =   1  'Graphical
         TabIndex        =   37
         ToolTipText     =   "Aceptar"
         Top             =   120
      ...
      Begin VB.CommandButton cmdCancelar 
         Appearance      =   0  'Flat
         DisabledPicture =   "frm_ExcepcionesHrs.frx":244A
         Height          =   375
         Left            =   5160
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "frm_ExcepcionesHrs.frx":25DE
         Picture         =   "frm_ExcepcionesHrs.frx":2730
         Style           =   1  'Graphical
         TabIndex        =   36
      ...
      Begin VB.PictureBox Pic_Cancelar 
         ...
         Height          =   375
         Left            =   5160
         MouseIcon       =   "frm_ExcepcionesHrs.frx":2BE3
         Picture         =   "frm_ExcepcionesHrs.frx":2D35
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   35
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Aceptar 
         ...
         Height          =   375
         Left            =   4680
         MouseIcon       =   "frm_ExcepcionesHrs.frx":3036
         Picture         =   "frm_ExcepcionesHrs.frx":3188
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   34
         Top             =   120
      ...
      Begin VB.CommandButton cmdModificar 
         Appearance      =   0  'Flat
         DisabledPicture =   "frm_ExcepcionesHrs.frx":3444
         Height          =   375
         Left            =   4080
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "frm_ExcepcionesHrs.frx":3565
         Picture         =   "frm_ExcepcionesHrs.frx":36B7
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton cmdBorrar 
         Appearance      =   0  'Flat
         DisabledPicture =   "frm_ExcepcionesHrs.frx":392A
         Height          =   375
         Left            =   3600
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "frm_ExcepcionesHrs.frx":3A40
         Picture         =   "frm_ExcepcionesHrs.frx":3B92
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton cmdAgregar 
         Appearance      =   0  'Flat
         DisabledPicture =   "frm_ExcepcionesHrs.frx":3D21
         Height          =   375
         Left            =   3120
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "frm_ExcepcionesHrs.frx":3E6E
         Picture         =   "frm_ExcepcionesHrs.frx":3FC0
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Agregar"
         Top             =   120
      ...
      Begin VB.CommandButton cmdUltimo 
         Appearance      =   0  'Flat
         DisabledPicture =   "frm_ExcepcionesHrs.frx":43FA
         Height          =   375
         Left            =   2520
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "frm_ExcepcionesHrs.frx":45A2
         Picture         =   "frm_ExcepcionesHrs.frx":46F4
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Ultimo"
         Top             =   120
      ...
      Begin VB.CommandButton cmdSiguiente 
         Appearance      =   0  'Flat
         DisabledPicture =   "frm_ExcepcionesHrs.frx":4BBF
         Height          =   375
         Left            =   2040
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "frm_ExcepcionesHrs.frx":4D2C
         Picture         =   "frm_ExcepcionesHrs.frx":4E7E
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      Begin VB.CommandButton cmdBuscar 
         Appearance      =   0  'Flat
         DisabledPicture =   "frm_ExcepcionesHrs.frx":52F3
         Height          =   375
         Left            =   1560
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "frm_ExcepcionesHrs.frx":547B
         Picture         =   "frm_ExcepcionesHrs.frx":55CD
         Style           =   1  'Graphical
         TabIndex        =   20
         ToolTipText     =   "Buscar"
         Top             =   120
      ...
      Begin VB.CommandButton cmdAnterior 
         Appearance      =   0  'Flat
         DisabledPicture =   "frm_ExcepcionesHrs.frx":58AA
         Height          =   375
         Left            =   1080
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "frm_ExcepcionesHrs.frx":5A14
         Picture         =   "frm_ExcepcionesHrs.frx":5B66
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton cmdPrimero 
         Appearance      =   0  'Flat
         DisabledPicture =   "frm_ExcepcionesHrs.frx":5FD4
         Height          =   375
         Left            =   600
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "frm_ExcepcionesHrs.frx":6179
         Picture         =   "frm_ExcepcionesHrs.frx":62CB
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Primero"
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Primero 
         ...
         Height          =   375
         Left            =   600
         MouseIcon       =   "frm_ExcepcionesHrs.frx":6786
         Picture         =   "frm_ExcepcionesHrs.frx":68D8
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   17
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Anterior 
         ...
         Height          =   375
         Left            =   1080
         MouseIcon       =   "frm_ExcepcionesHrs.frx":6D93
         Picture         =   "frm_ExcepcionesHrs.frx":6EE5
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   16
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Buscar 
         ...
         Height          =   375
         Left            =   1560
         MouseIcon       =   "frm_ExcepcionesHrs.frx":7353
         Picture         =   "frm_ExcepcionesHrs.frx":74A5
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   15
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Siguiente 
         ...
         Height          =   375
         Left            =   2040
         MouseIcon       =   "frm_ExcepcionesHrs.frx":7782
         Picture         =   "frm_ExcepcionesHrs.frx":78D4
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   14
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Ultimo 
         ...
         Height          =   375
         Left            =   2520
         MouseIcon       =   "frm_ExcepcionesHrs.frx":7D49
         Picture         =   "frm_ExcepcionesHrs.frx":7E9B
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   13
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Agregar 
         ...
         Height          =   375
         Left            =   3120
         MouseIcon       =   "frm_ExcepcionesHrs.frx":8366
         Picture         =   "frm_ExcepcionesHrs.frx":84B8
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   12
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Borrar 
         ...
         Height          =   375
         Left            =   3600
         MouseIcon       =   "frm_ExcepcionesHrs.frx":88F2
         Picture         =   "frm_ExcepcionesHrs.frx":8A44
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   11
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Modificar 
         ...
         Height          =   375
         Left            =   4080
         MouseIcon       =   "frm_ExcepcionesHrs.frx":8BD3
         Picture         =   "frm_ExcepcionesHrs.frx":8D25
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   10
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Modificar_Gris 
         ...
         Height          =   375
         Left            =   4080
         MouseIcon       =   "frm_ExcepcionesHrs.frx":8F98
         Picture         =   "frm_ExcepcionesHrs.frx":90EA
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   26
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Borrar_Gris 
         ...
         Height          =   375
         Left            =   3600
         MouseIcon       =   "frm_ExcepcionesHrs.frx":920B
         Picture         =   "frm_ExcepcionesHrs.frx":935D
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   27
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Agregar_Gris 
         ...
         Height          =   375
         Left            =   3120
         MouseIcon       =   "frm_ExcepcionesHrs.frx":9473
         Picture         =   "frm_ExcepcionesHrs.frx":95C5
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   28
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Ultimo_Gris 
         ...
         Height          =   375
         Left            =   2520
         MouseIcon       =   "frm_ExcepcionesHrs.frx":9712
         Picture         =   "frm_ExcepcionesHrs.frx":9864
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   29
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Siguiente_Gris 
         ...
         Height          =   375
         Left            =   2040
         MouseIcon       =   "frm_ExcepcionesHrs.frx":9A0C
         Picture         =   "frm_ExcepcionesHrs.frx":9B5E
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   30
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Buscar_Gris 
         ...
         Height          =   375
         Left            =   1560
         MouseIcon       =   "frm_ExcepcionesHrs.frx":9CCB
         Picture         =   "frm_ExcepcionesHrs.frx":9E1D
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   31
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Anterior_Gris 
         ...
         Height          =   375
         Left            =   1080
         MouseIcon       =   "frm_ExcepcionesHrs.frx":9FA5
         Picture         =   "frm_ExcepcionesHrs.frx":A0F7
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   32
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Primero_Gris 
         ...
         Height          =   375
         Left            =   600
         MouseIcon       =   "frm_ExcepcionesHrs.frx":A261
         Picture         =   "frm_ExcepcionesHrs.frx":A3B3
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   33
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Aceptar_Gris 
         ...
         Height          =   375
         Left            =   4680
         MouseIcon       =   "frm_ExcepcionesHrs.frx":A558
         Picture         =   "frm_ExcepcionesHrs.frx":A6AA
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   38
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Cancelar_Gris 
         ...
         Height          =   375
         Left            =   5160
         MouseIcon       =   "frm_ExcepcionesHrs.frx":A803
         Picture         =   "frm_ExcepcionesHrs.frx":A955
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   39
         Top             =   120
      ...
      Begin VB.CommandButton cmdImprimir 
         Appearance      =   0  'Flat
         DisabledPicture =   "frm_ExcepcionesHrs.frx":AAE9
         Height          =   375
         Left            =   0
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frm_ExcepcionesHrs.frx":AC41
         Style           =   1  'Graphical
         TabIndex        =   41
      ...
      Begin VB.PictureBox Pic_Imprimir_Gris 
         ...
         Height          =   375
         Left            =   0
         MouseIcon       =   "frm_ExcepcionesHrs.frx":B0C1
         Picture         =   "frm_ExcepcionesHrs.frx":B213
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   42
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Imprimir 
         ...
         Height          =   375
         Left            =   0
         MouseIcon       =   "frm_ExcepcionesHrs.frx":B36B
         Picture         =   "frm_ExcepcionesHrs.frx":B4BD
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   40
         Top             =   120
   ...
   End
End
Attribute VB_Name = "frm_ExcepcionesHrs"
...
Dim hrDesde, hrHasta As String 'se actualizan en caso de estadoAbm = 3
...
hrDesde = Me.MaskEdBox1(0).Text
hrHasta = Me.MaskEdBox1(1).Text
...
Select Case estadoAbm
    ...
    Case Is = 3
        ...
        strQuery = " select * from excepcionesHrs where ehr_idProf = " & DataCombo1.BoundText & " and ehr_fecha = #" & DTPicker1.Value & "# and ehr_hrDesde <> '" & hrDesde & "' and ehr_hrHasta <> '" & hrHasta & "'"
