...
Begin VB.Form o_botenes_abm 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox Pic_Cancelar 
         ...
         Height          =   375
         Left            =   5160
         MouseIcon       =   "clase_btns_abm.frx":0000
         Picture         =   "clase_btns_abm.frx":0152
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   21
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Aceptar 
         ...
         Height          =   375
         Left            =   4680
         MouseIcon       =   "clase_btns_abm.frx":0453
         Picture         =   "clase_btns_abm.frx":05A5
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   20
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Modificar 
         ...
         Height          =   375
         Left            =   4080
         MouseIcon       =   "clase_btns_abm.frx":0861
         Picture         =   "clase_btns_abm.frx":09B3
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   19
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Borrar 
         ...
         Height          =   375
         Left            =   3600
         MouseIcon       =   "clase_btns_abm.frx":0C26
         Picture         =   "clase_btns_abm.frx":0D78
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   18
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Agregar 
         ...
         Height          =   375
         Left            =   3120
         MouseIcon       =   "clase_btns_abm.frx":0F07
         Picture         =   "clase_btns_abm.frx":1059
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   17
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Ultimo 
         ...
         Height          =   375
         Left            =   2520
         MouseIcon       =   "clase_btns_abm.frx":1493
         Picture         =   "clase_btns_abm.frx":15E5
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   16
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Siguiente 
         ...
         Height          =   375
         Left            =   2040
         MouseIcon       =   "clase_btns_abm.frx":1AB0
         Picture         =   "clase_btns_abm.frx":1C02
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   15
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Buscar 
         ...
         Height          =   375
         Left            =   1560
         MouseIcon       =   "clase_btns_abm.frx":2077
         Picture         =   "clase_btns_abm.frx":21C9
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   14
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Anterior 
         ...
         Height          =   375
         Left            =   1080
         MouseIcon       =   "clase_btns_abm.frx":24A6
         Picture         =   "clase_btns_abm.frx":25F8
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   13
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Primero 
         ...
         Height          =   375
         Left            =   600
         MouseIcon       =   "clase_btns_abm.frx":2A66
         Picture         =   "clase_btns_abm.frx":2BB8
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   12
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Primero_Gris 
         ...
         Height          =   375
         Left            =   600
         MouseIcon       =   "clase_btns_abm.frx":3073
         Picture         =   "clase_btns_abm.frx":31C5
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   31
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Anterior_Gris 
         ...
         Height          =   375
         Left            =   1080
         MouseIcon       =   "clase_btns_abm.frx":336A
         Picture         =   "clase_btns_abm.frx":34BC
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   30
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Buscar_Gris 
         ...
         Height          =   375
         Left            =   1560
         MouseIcon       =   "clase_btns_abm.frx":3626
         Picture         =   "clase_btns_abm.frx":3778
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   29
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Siguiente_Gris 
         ...
         Height          =   375
         Left            =   2040
         MouseIcon       =   "clase_btns_abm.frx":3900
         Picture         =   "clase_btns_abm.frx":3A52
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   28
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Ultimo_Gris 
         ...
         Height          =   375
         Left            =   2520
         MouseIcon       =   "clase_btns_abm.frx":3BBF
         Picture         =   "clase_btns_abm.frx":3D11
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   27
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Agregar_Gris 
         ...
         Height          =   375
         Left            =   3120
         MouseIcon       =   "clase_btns_abm.frx":3EB9
         Picture         =   "clase_btns_abm.frx":400B
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   26
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Borrar_Gris 
         ...
         Height          =   375
         Left            =   3600
         MouseIcon       =   "clase_btns_abm.frx":4158
         Picture         =   "clase_btns_abm.frx":42AA
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   25
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Modificar_Gris 
         ...
         Height          =   375
         Left            =   4080
         MouseIcon       =   "clase_btns_abm.frx":43C0
         Picture         =   "clase_btns_abm.frx":4512
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   24
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Aceptar_Gris 
         ...
         Height          =   375
         Left            =   4680
         MouseIcon       =   "clase_btns_abm.frx":4633
         Picture         =   "clase_btns_abm.frx":4785
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   23
         Top             =   120
      ...
      Begin VB.PictureBox Pic_Cancelar_Gris 
         ...
         Height          =   375
         Left            =   5160
         MouseIcon       =   "clase_btns_abm.frx":48DE
         Picture         =   "clase_btns_abm.frx":4A30
         ScaleHeight     =   375
         ScaleWidth      =   375
         TabIndex        =   22
         Top             =   120
      ...
      Begin VB.CommandButton cmdImprimir 
         Appearance      =   0  'Flat
         DisabledPicture =   "clase_btns_abm.frx":4BC4
         Height          =   375
         Left            =   0
         MaskColor       =   &H00FFFFFF&
         Picture         =   "clase_btns_abm.frx":52D4
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton cmdCancelar 
         Appearance      =   0  'Flat
         DisabledPicture =   "clase_btns_abm.frx":59D8
         Height          =   375
         Left            =   5160
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "clase_btns_abm.frx":5B6C
         Picture         =   "clase_btns_abm.frx":5CBE
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton cmdAceptar 
         Appearance      =   0  'Flat
         DisabledPicture =   "clase_btns_abm.frx":6171
         Height          =   375
         Left            =   4680
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "clase_btns_abm.frx":62CA
         Picture         =   "clase_btns_abm.frx":641C
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Aceptar"
         Top             =   120
      ...
      Begin VB.CommandButton cmdModificar 
         Appearance      =   0  'Flat
         DisabledPicture =   "clase_btns_abm.frx":66D8
         Height          =   375
         Left            =   4080
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "clase_btns_abm.frx":67F9
         Picture         =   "clase_btns_abm.frx":694B
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmdBorrar 
         Appearance      =   0  'Flat
         DisabledPicture =   "clase_btns_abm.frx":6BBE
         Height          =   375
         Left            =   3600
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "clase_btns_abm.frx":6CD4
         Picture         =   "clase_btns_abm.frx":6E26
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdAgregar 
         Appearance      =   0  'Flat
         DisabledPicture =   "clase_btns_abm.frx":6FB5
         Height          =   375
         Left            =   3120
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "clase_btns_abm.frx":7102
         Picture         =   "clase_btns_abm.frx":7254
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Agregar"
         Top             =   120
      ...
      Begin VB.CommandButton cmdUltimo 
         Appearance      =   0  'Flat
         DisabledPicture =   "clase_btns_abm.frx":768E
         Height          =   375
         Left            =   2520
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "clase_btns_abm.frx":7836
         Picture         =   "clase_btns_abm.frx":7988
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Ultimo"
         Top             =   120
      ...
      Begin VB.CommandButton cmdSiguiente 
         Appearance      =   0  'Flat
         DisabledPicture =   "clase_btns_abm.frx":7E53
         Height          =   375
         Left            =   2040
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "clase_btns_abm.frx":7FC0
         Picture         =   "clase_btns_abm.frx":8112
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmdBuscar 
         Appearance      =   0  'Flat
         DisabledPicture =   "clase_btns_abm.frx":8587
         Height          =   375
         Left            =   1560
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "clase_btns_abm.frx":870F
         Picture         =   "clase_btns_abm.frx":8861
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Buscar"
         Top             =   120
      ...
      Begin VB.CommandButton cmdAnterior 
         Appearance      =   0  'Flat
         DisabledPicture =   "clase_btns_abm.frx":8B3E
         Height          =   375
         Left            =   1080
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "clase_btns_abm.frx":8CA8
         Picture         =   "clase_btns_abm.frx":8DFA
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdPrimero 
         Appearance      =   0  'Flat
         DisabledPicture =   "clase_btns_abm.frx":9268
         Height          =   375
         Left            =   600
         MaskColor       =   &H00FFFFFF&
         MouseIcon       =   "clase_btns_abm.frx":940D
         Picture         =   "clase_btns_abm.frx":955F
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Primero"
         Top             =   120
